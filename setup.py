...
PACKAGENAME = metadata.get('package_name', 'jirahub')
DESCRIPTION = metadata.get('description', 'A package for syncing JIRA tickets and Github issues')
AUTHOR = metadata.get('author', 'Steve Crawford')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/spacetelescope/jirahub')
